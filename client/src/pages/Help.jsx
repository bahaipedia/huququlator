        ...
        <div className="help-container">
            ...
            <div className="faq-section">
                ...
                <div className="faq-item" id="faq2">
                    <h2 onClick={() => toggle('faq2')}>
                        <span>Excess Wealth</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq3">
                    <h2 onClick={() => toggle('faq3')}>
                        <span>Unnecessary Expenditures</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq4">
                    <h2 onClick={() => toggle('faq4')}>
                        <span>Wealth Ḥuqúq Has Already Been Paid On</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq5">
                    <h2 onClick={() => toggle('faq5')}>
                        <span>Value of 19 Mithqáls of Gold</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq6">
                    <h2 onClick={() => toggle('faq6')}>
                        <span>Payment Due on the Following Units of Ḥuqúq</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq7">
                    <h2 onClick={() => toggle('faq7')}>
                        <span>The Amount of Wealth You Are Paying Ḥuqúq On Today</span>
                        <button className="view-more">
                ...
                <div className="faq-item" id="faq8">
                    <h2 onClick={() => toggle('faq8')}>
                        <span>19% of the Above</span>
                        <button className="view-more">
