...
export default function Help() {
    ...
    return (
        <div className="help-container">
            ...
            <p className="georgia-text">Below are answers to common questions and explanations for each section of the calculator.</p>

            <div className="faq-section">
                {/* FAQ 1 */}
                <div className="faq-item" id="faq1">
                    <h2 onClick={() => toggle('faq1')}>What is Ḥuqúqu’lláh?</h2>
                    <div className={`faq-content ${expanded['faq1'] ? 'expanded' : ''}`}>
                        <p>Ḥuqúqu’lláh is a voluntary tax on wealth that applies to members of the Bahá’í faith who meet certain requirements. Bahá’u’lláh writes, "Should anyone acquire one hundred mithqáls of gold, nineteen mithqáls thereof are God’s and to be rendered unto Him, the Fashioner of earth and heaven." <a href="https://www.bahai.org/library/authoritative-texts/bahaullah/kitab-i-aqdas/6#443108496" target="_blank" rel="noreferrer" className="note-link">Kitáb-i-Aqdas</a></p>
                    ...
                    <button className="view-more" onClick={() => toggle('faq1')}>
                        {expanded['faq1'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 2 */}
                <div className="faq-item" id="faq2">
                    <h2 onClick={() => toggle('faq2')}>Excess Wealth</h2>
                    <div className={`faq-content ${expanded['faq2'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq2')}>
                        {expanded['faq2'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 3 */}
                <div className="faq-item" id="faq3">
                    <h2 onClick={() => toggle('faq3')}>Unnecessary Expenditures</h2>
                    <div className={`faq-content ${expanded['faq3'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq3')}>
                        {expanded['faq3'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 4 */}
                <div className="faq-item" id="faq4">
                    <h2 onClick={() => toggle('faq4')}>Wealth Ḥuqúq Has Already Been Paid On</h2>
                    <div className={`faq-content ${expanded['faq4'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq4')}>
                        {expanded['faq4'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 5 */}
                <div className="faq-item" id="faq5">
                    <h2 onClick={() => toggle('faq5')}>Value of 19 Mithqáls of Gold</h2>
                    <div className={`faq-content ${expanded['faq5'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq5')}>
                        {expanded['faq5'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 6 */}
                <div className="faq-item" id="faq6">
                    <h2 onClick={() => toggle('faq6')}>Payment Due on the Following Units of Ḥuqúq</h2>
                    <div className={`faq-content ${expanded['faq6'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq6')}>
                        {expanded['faq6'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 7 */}
                <div className="faq-item" id="faq7">
                    <h2 onClick={() => toggle('faq7')}>The Amount of Wealth You Are Paying Ḥuqúq On Today</h2>
                    <div className={`faq-content ${expanded['faq7'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq7')}>
                        {expanded['faq7'] ? 'Collapse' : 'View'}
                    </button>
                </div>

                {/* FAQ 8 */}
                <div className="faq-item" id="faq8">
                    <h2 onClick={() => toggle('faq8')}>19% of the Above</h2>
                    <div className={`faq-content ${expanded['faq8'] ? 'expanded' : ''}`}>
                    ...
                    <button className="view-more" onClick={() => toggle('faq8')}>
                        {expanded['faq8'] ? 'Collapse' : 'View'}
                    </button>
                </div>
            </div>
        </div>
